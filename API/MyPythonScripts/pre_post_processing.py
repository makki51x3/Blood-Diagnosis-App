...
########################################################################################################################
#########################################       MODEL ARCHITECHTURE AND METRICS       ##################################    
########################################################################################################################
...
def smoothBlending(img):
    ...
    # Setup Unet Model
    model = Attention_ResUNet(input_shape=(256,256,3), NUM_CLASSES=1, dropout_rate=0.0, batch_norm=True)

    # Load weights
    model.load_weights(baseDir+'Codocyte_100_weights.h5') 
